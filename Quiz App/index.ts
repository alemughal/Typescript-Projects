...
class Question {
  constructor(public questionText: string, public options: string[], public correctOptionIndex: number) {}
}

// Function to display the quiz questions
function displayQuiz(questions: Question[]): void {
...
async function takeQuiz(questions: Question[]): Promise<number> {
  let score = 0;
...
function displayResults(totalQuestions: number, score: number): void {
