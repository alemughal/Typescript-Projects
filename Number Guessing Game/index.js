...
function startGame() {
    async function runGame() {
        ...
        const greetingMessage = boxen(chalk.blue.bold(`Welcome! My name is Ali`) +
            "\n" +
            chalk.magenta.bold(`Let's play a guessing game... \n I'm thinking of a number between 1 and 10. Can you guess it?`) +
        ...
        while (!isValidInput) {
            ...
            if (userGuess === randomNumber) {
                ...
                console.log(chalk.red.bold(`Sorry, try again!`));
                console.log(chalk.yellow.bold("Better luck next time!")); // Static message
            }
        }
        // Display the random number
        console.log(boxen(chalk.yellow.bold(`Random Number was ${randomNumber}`), { padding: 1, margin: 1, borderStyle: "double" }));
